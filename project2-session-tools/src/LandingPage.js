        ...
        return (
            <React.Fragment>
                <main>
                    ...
                    <div className="container showcase-area justify-content-center">
                        <div className="container row">
                            <div className="container left col-12 col-md-6 order-md-first order-last">
                            ...
                            <div className="container right col-12 col-md-6">
